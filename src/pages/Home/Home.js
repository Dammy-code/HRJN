...
export const Home = () => {
  return (
   <MainLayout  className = 'z-[-1] '>
    <Header />
      <div className="w-full select-none lg:border-none ">
        {/*About us  */}
        <div className="w-[100%] sm:h-[240vh] md:h-[160vh] flex lg:w-[1280px] lg:h-[724.36px]  flex-col mt-[6rem] left-[0] right-[0] mr-auto ml-auto " >
            ...
            <div className='sm:h-[160vh] md:h-[100vh] flex flex-col lg:w-[1280px] lg:h-[578.34px]  lg:flex-row lg:justify-between mb-[40px]'>
              ...
              <div className='h-[82vh] lg:w-[704px] lg:h-[494px] lg:mt-[50px]'>
                  ...
                  <p className='w-[68%] font-[400] md:w-[80%] lg:w-[608px] lg:h-[156px] text-[16px] leading-[160%] text-[#525560] mb-[40px]'>
                  ...
                  <button className='sm:mb-[20px] bg-[#70C174] border-[4px] flex flex-row items-center justify-center gap-[10px] py-[16px] px-[32px] cursor w-[146px] h-[51px] border-none text-white'>
              ...
              {/* video */}
              <div className='w-[90%] md:w-[60%] mt-[25px] md:mb-[40px] mr-auto ml-auto h-[80vh] lg:w-[480px] lg:h-[578.434px] relative bg-banner  bg-no-repeat z-[50]'>
                <img src={Play} className='absolute top-[17rem] right-[0] left-[0]  mx-auto my-auto w-[45px] h-[45px] cursor-pointer ' />
              </div>
            </div>
            {/* bottom */}
          <div className='flex flex-col items-center w-full lg:w-[1280px] lg:h-[82.02px] '>
              {/* section title */}
        ...
        {/* what we do */}
        <div className='w-full sm:h-[230vh] md:h-[160vh] lg:h-[901px] bg-[#EFF7F2] rounded-[0px] pt-[5rem]'>
          {/* section title */}
          ...
          <div className='flex w-[88%] sm:h-[200vh] md:h-[130vh] lg:h-[658px] mx-auto flex-col lg:flex-row items-center justify-between'>
            ...
            {/* what we do Image */}
            <div className='w-[99%] sm:h-[90vh] md:h-[67vh] md:w-[70%] lg:w-[480px] lg:h-[658px] rounded-[12px] bg-workImage bg-cover bg-no-repeat'></div>
          </div>
        </div>
